...
ASUNTOS_COMUNES = [
    ...
    "AUTO POR EL CUAL SE COMISIONA A UN FUNCIONARIO PUBLICO PARA LA PRACTICA DE PRUEBAS EN INVESTIGACION DISCIPLINARIA",
    ...
    "AUTO DE VINCULACIÓN A INVESTIGACIÓN DISCIPLINARIA",
]
